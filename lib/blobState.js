...
async function readBlobJson(pathname) {
  // Use the SDK's supported private-blob read path. Omitting `token` lets
  // @vercel/blob use the deployment's configured authentication, including
  // Vercel OIDC for projects upgraded to OIDC, while still supporting
  // BLOB_READ_WRITE_TOKEN for existing stores.
